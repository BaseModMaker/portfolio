      ...
      >
        ...
        <div className="rpg-textbox" style={{ 
          ...
          <div className="textbox-content" style={{
            ...
            // boxShadow: `0 0 20px var(--label-border-shadow-color-${planetName}, #64ffda)33, inset 0 2px 0 rgba(255, 0, 0, 0.1)`,
            boxShadow: `0 0 20px var(--label-border-shadow-color-${planetName}, #64ffda),inset 0 2px 0 rgba(255, 0, 0, 0.1)`,
            position: 'relative',
            margin: '0',
